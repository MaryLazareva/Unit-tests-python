...
'''
"Я тестировала функцию find_average для различных типов списков: пустых,
с одним элементом и со многими элементами, чтобы убедиться, что функция корректно обрабатывает различные
входные данные."
"Для функции compare_averages я решила проверить все возможные сценарии: когда средние значения равны, когда один
